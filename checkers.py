...
my_frame = Frame(root, width=500, height=500, bg="black")
...
white_pawn_image = PhotoImage(file="img/white_pawn_1.png")
red_pawn_image = PhotoImage(file="img/red_pawn_1.png")
white_queen_image = PhotoImage(file="img/white_queen_1.png")
red_queen_image = PhotoImage(file="img/red_queen_1.png")
white_bg = PhotoImage(file="img/white_bg.png")
grey_bg = PhotoImage(file="img/grey_bg.png")

white_pawn_highlighted_image = PhotoImage(file="img/white_pawn_highlighted_1.png")
red_pawn_highlighted_image = PhotoImage(file="img/red_pawn_highlighted_1.png")
white_queen_highlighted_image = PhotoImage(file="img/white_queen_highlighted_1.png")
red_queen_highlighted_image = PhotoImage(file="img/red_queen_highlighted_1.png")
highlighted_bg = PhotoImage(file="img/highlighted_bg.png")
...
def get_queen_moves(my_list, coords):
    ...
    for enemy in my_list:
        if COORDS_FIGURE_DICT[enemy][0] != COORDS_FIGURE_DICT[coords][0] and COORDS_FIGURE_DICT[enemy][1] != "0":
            for square_to_move_to in my_list:
...
def move_figure(new_coords):
    ...
    if new_coords in MOVES_BEATING_DICT:
        ...
        image_names_dict = {tuple(["white", "pawn"]): white_pawn_image, tuple(["white", "queen"]): white_queen_image,
